...
# $CMD_MYSQL -e "insert into customer (guid,company_id,name,president_name,tel,zip_code,address) values ('9bsv0s6m409g02pr4mug',1,'customer1','president1','090-1111-2222','111-2222','address2');"
